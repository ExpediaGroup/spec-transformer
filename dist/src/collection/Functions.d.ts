 ...
 */
export declare function map(record: Record<Key, Value>, transformer: (k: Key, v: Value) => [k: Key, v: Value]): Record<Key, Value>;
/**
 ...
 */
export declare function filter(record: Record<Key, Value>, predicate: (k: Key, v: Value) => boolean): Record<Key, Value>;
